defmodule EctoQueryRuntimeChecks.Error do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          errors: EctoQueryRuntimeChecks.errors(),
  ...
  def exception(opts) do
    ...
    runtime_opts_key = Keyword.get(opts, :runtime_opts_key, :ecto_query_runtime_checks)
